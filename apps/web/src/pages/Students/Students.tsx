...
function AverageBar({ value }: { value: number }) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
      <span style={{ fontSize: 13, color: '#111827', fontWeight: 500, minWidth: 36 }}>
        {value.toFixed(1)}/10
      </span>
      <div style={{ height: 4, background: '#e5e7eb', borderRadius: 2, width: 80, flexShrink: 0 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
        ...
        <input
          ...
          style={{
            ...
            fontSize: 14, width: 220, color: '#374151', outline: 'none',
          }}
        />
      </div>
