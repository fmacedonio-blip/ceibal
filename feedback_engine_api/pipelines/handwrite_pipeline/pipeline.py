...
from .call1 import analizar
from .call2 import generar
from .client import build_text_compatibility_image, coerce_image_input
from .curriculum import validate_course
from .models import OutputFinal, PipelineInput
...
def run(
    ...
    *,
    ...
    """
    Ruta principal multimodal por curso/tramo curricular.

    Compatibilidad transitoria:
    - `texto_compatibilidad` sigue disponible solo para fixtures y pruebas internas.
    - La lógica pedagógica ya no usa edad; el eje principal es `curso`.
    """
