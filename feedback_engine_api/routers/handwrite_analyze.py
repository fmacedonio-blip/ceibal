...
from schemas.handwrite_analyze import HandwriteAnalyzeResponse
from services.handwrite_analyze import DEFAULT_MODEL, HandwriteAnalyzeError, analyze
...
@router.post("/", response_model=HandwriteAnalyzeResponse)
async def handwrite_analyze(
    imagen: UploadFile = File(...),
    curso: int = Form(...),
    modelo: str = Form(DEFAULT_MODEL),
) -> HandwriteAnalyzeResponse:
